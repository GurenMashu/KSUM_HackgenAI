...
class KeywordEngine:
    def __init__(self):
        tokenizer_keyword, model_keyword = model_init() 
        self.model = model_keyword
        self.tokenizer = tokenizer_keyword
    ...
    def extract_keyword(self, prompt):
        ...
        self.generated_text = llm.generate_response(llm_model=self.model, llm_tokenizer=self.tokenizer, prompt_user=self.user_prompt, prompt_system=self.system_prompt, temperature=0.3, max_tokens=100)
